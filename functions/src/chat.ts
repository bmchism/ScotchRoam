...
const SYSTEM = `You are Scotch Roam's in-app Scotch whisky guide — warm, knowledgeable, and concise.
Answer questions about Scotch whisky: how it's made, brands, distilleries, expressions
...
- If a question is clearly unrelated to Scotch/whisky or drinking culture, politely
...
export const handler = async (event: AppSyncEvent): Promise<string> => {
  ...
  if (!message) return "Ask me anything about Scotch whisky — how it's made, a brand, an expression, a cocktail…";
