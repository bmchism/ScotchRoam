    ...
    <>
      ...
      <main className="screen info">
        <div className="page-title">
          ...
          <h1>About Scotch Roam</h1>
        </div>

        <p className="lead">
          Scotch Roam turns any get-together into a guided Scotch tasting. Build a
        ...
        <p>
          Scotch Roam is independent. Bottle names, labels, and logos are trademarks
