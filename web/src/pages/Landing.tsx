    ...
    <div className="landing">
      ...
      >
        ...
        <div className="land-hero-overlay">
          <div className="land-mark"><BottleMark size={30} /> <span>Scotch Roam</span></div>
          ...
          <p className="land-hero-sub">
            Turn any get-together into a guided Scotch tasting — pour, score each
      ...
      <section className="land-about">
        <div className="section-head land-center">
          ...
          <h2>Your Scotch companion</h2>
        </div>
        <p className="land-sub land-center-text">
          Scotch Roam is a guided home for bourbon exploration. Build a flight,
