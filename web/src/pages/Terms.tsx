  ...
  return (
    <>
      ...
      <main className="screen info">
        ...
        <p className="lead">
          By using Scotch Roam you agree to these terms. Please read them — they
        ...
        <p>
          ...
          States) to use Scotch Roam. By using the app you confirm that you are.
        ...
        <p>
          ...
          shown for identification and education (nominative use). Scotch Roam is
        ...
        <p>
          To the maximum extent permitted by law, Scotch Roam is not liable for any
