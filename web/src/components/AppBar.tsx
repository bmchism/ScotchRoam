...
export default function AppBar({
  ...
  const brand = !back && title === "Scotch Roam";
  ...
  const crumbs = back && user ? crumbTrail(pathname, title === "Scotch Roam" ? undefined : title) : [];
      ...
      <header className="appbar">
        ...
        {brand ? (
          <Link to="/home" aria-label="Home">
            <img src="/logo.svg" alt="Scotch Roam" style={{ height: 30, display: "block" }} />
          </Link>
        ) : (
          <>
            {!back && (
