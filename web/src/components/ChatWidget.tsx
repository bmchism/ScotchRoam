...
const GREETING: Msg = {
  role: "assistant",
  content: "Cheers! I'm your Scotch whisky guide. Ask me about a mash bill, a distillery, how bourbon is aged, or what to pour at your next tasting.",
};
const SUGGESTIONS = [
...
// Floating Scotch whisky assistant. Hovers bottom-right; opens a chat panel.
  ...
  return (
    <>
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        aria-label={open ? "Close assistant" : "Ask the Scotch whisky assistant"}
      >
        {open ? "✕" : "🍷"}
      </button>
        ...
        {open && (
          ...
          >
            <div className="chat-head">
              ...
              <span className="chat-sub">Ask me anything about Scotch</span>
            </div>
